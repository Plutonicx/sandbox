...
def netG_loss(inputs, cycle_loss_weight=7):
...
train_A = load_data('zebrahorse/horse2zebra/trainA/*')
train_B = load_data('zebrahorse/horse2zebra/trainB/*')
print(len(train_A))
print(len(train_B))


val_A = load_data('zebrahorse/horse2zebra/testA/*')
val_B = load_data('zebrahorse/horse2zebra/testB/*')
print(len(val_A))
print(len(val_B))
